...
class Fb {
    ...
    async getExtIp(){
        try {
            ...
            let extIp = await this.soapAction(this, '/upnp/control/wanpppconn1', 'urn:dslforum-org:service:WANPPPConnection:1', 'GetInfo', null, true);
    ...
    async soapAction(device, url, serviceType, action, vars, suppressMsg = false) {
        ...
        try {
            ...
            if (device._sslPort && device._auth.auth && this.that.config.ssl) {
