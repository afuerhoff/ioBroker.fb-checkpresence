...
class Fb {
    ...
    async getExtIp(){
        try {
            ...
            if(this.GETEXTIP && this.GETEXTIP == true && (this.accessType == 'DSL' || this.accessType == 'X_AVM-DE_LTE' || this.accessType == 'X_AVMDE_UMTS' || this.accessType == 'X_AVM-DE_Fiber')){
                await this.soapAction('/upnp/control/wanpppconn1', 'urn:dslforum-org:service:' + 'WANPPPConnection:1', 'GetInfo', null, soapResult);
            }
            if (this.GETEXTIPBYIP && this.GETEXTIPBYIP == true && (this.accessType == 'Ethernet' || this.accessType == 'X_AVM-DE_Cable')) {
