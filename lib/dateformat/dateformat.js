...
//Changes:
// afuerhoff 2022.07.31: initial copy of v4.5.1 https://github.com/felixge/node-dateformat/blob/v4.5.1/src/dateformat.js
//                       based on https://blog.stevenlevithan.com/archives/javascript-date-format
    ...
    const dateFormat = (() => {
        ...
        return (date, mask, utc, gmt) => {
            ...
            const flags = {
                ...
                p: () =>
                    `${(o() > 0 ? '-' : '+') + pad(Math.floor(Math.abs(o()) / 60), 2)}:${pad(
