...
async function createMeshObjects(that, device, channel) { 
    try {
        ...
        const opt = [
            ...
            ['fb-devices.' + hostName + '.' + channel + '.cur_data_rate_rx', 'state', 'fb-devices.' + hostName + '.' + channel + '.cur_data_rate_rx', 'string', 'value', '', true, false, 'Current data rate rx of the interface'],
            ['fb-devices.' + hostName + '.' + channel + '.cur_data_rate_tx', 'state', 'fb-devices.' + hostName + '.' + channel + '.cur_data_rate_tx', 'string', 'value', '', true, false, 'Current data rate tx of the interface'],
