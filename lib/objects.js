            ...
            for (let k = 0; k < membersFiltered.length; k++) {
                ...
                if (group == '' && that.config.compatibility === true){
                    opt = [
                        ...
                        [group + member + '.speed', 'state', member + '.speed', 'number', 'value', 0, true, false, 'Speed of the device'],
                ...
                if (group == '' && that.config.compatibility === false){
                    opt = [
                        ...
                        ['familyMembers.' + group + member + '.speed', 'state', member + '.speed', 'number', 'value', '', true, false, 'Speed of the device'],
                        ['familyMembers.' + group + member + '.absent.since', 'state', member + '.absent.since', 'number', 'value', '0', true, false, 'absent since'],
                        ['familyMembers.' + group + member + '.present.since', 'state', member + '.present.since', 'number', 'value', '0', true, false, 'present since'],
                        ['familyMembers.' + group + member + '.absent.sum_day', 'state', member + '.absent.sum_day', 'number', 'value', '0', true, false, 'how long absent per day'],
                        ['familyMembers.' + group + member + '.present.sum_day', 'state', member + '.present.sum_day', 'number', 'value', '0', true, false, 'how long present per day']
                    ];
                }
                if (group != ''){
                    opt = [
